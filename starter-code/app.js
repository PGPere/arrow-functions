...
// Answer: Window {window: Window, self: Window, document: document, name: '', location: Location, …}

// 3. Explain why "this" is different when an arrow function is used.
// Answer: Because arrow function can not use "this"
